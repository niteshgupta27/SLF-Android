...
import com.storelogflog.adapter.SubscriptionAdapter;
import com.storelogflog.apiCall.NotiifcationListApiCall;
import com.storelogflog.apiCall.PricingApiCall;
import com.storelogflog.apiCall.SubcriptionListApiCall;
...
import com.storelogflog.bean.subscriptionBean.SubscriptionBean;
import com.storelogflog.callBackInterFace.RenewSubscription;
                                ...
                                if(subscriptionBean!=null && subscriptionBean.getSubscripiton()!=null && subscriptionBean.getSubscripiton().size()>0)
                                {
                                    ...
                                    adapter = new SubscriptionAdapter(SubscriptionActivity.this, subscriptionBean.getSubscripiton(), new RenewSubscription() {
                                        ...
                                        public void renewClick(Subscripiton subscripiton) {
                                            ...
                                            Log.e("pondValue2", String.valueOf(pondValue));
                                        }
                                    });
