...
import com.storelogflog.apiCall.StorageListApiCall;
...
public class StorageListFragment extends BaseFragment implements VolleyApiResponseString, SearchView.OnQueryTextListener {
    ...
    public  void callStorageListApi()
    {
