...
import com.storelogflog.adapter.StorageUnitAdapter;
...
public class StorageDetailsFragment extends BaseFragment implements VolleyApiResponseString {
    ...
    private RelativeLayout imgChat, img_card, imgLog,clam_my_room;
    ...
    public void initViews(View view) {
        ...
        clam_my_room = view.findViewById(R.id.clam_my_room);
    ...
    public void initListeners() {
        ...
        clam_my_room.setOnClickListener(new View.OnClickListener() {
            @Override
